...
Detect fixations and saccades using the **I-DT** (Identification by Dispersion Threshold) algorithm. The I-DT algorithm identifies fixations as groups of consecutive samples where the  
